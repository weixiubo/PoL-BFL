...
class TestAnchorRegistryE2E(unittest.TestCase):
    ...
    def test_01_anchor_registry_deployed(self):
        ...
        print(f"✅ AnchorRegistry deployed at: {self.chain_proxy.anchor_registry.address}")
    ...
    def test_02_anchor_round_basic(self):
        ...
        print(f"✅ Round anchored: txid={result['txid']}, block={result['blockNumber']}")
    ...
    def test_03_anchor_round_query(self):
        ...
        print(f"✅ Anchor verified: commit={stored_commit_hash[:16]}..., sigset={stored_sigset_hash[:16]}...")
    ...
    def test_04_anchor_round_duplicate_prevention(self):
        ...
        print(f"✅ Duplicate anchoring prevented: {error_msg[:100]}")
    ...
    def test_05_integration_with_aggregator(self):
        ...
        try:
            ...
            print(f"✅ Aggregator integration successful: txid={agg._metrics['anchor_txid']}, block={agg._metrics['anchor_block']}")
    ...
    def test_06_anchor_verification(self):
        ...
        print(f"✅ Anchor verification working: correct=True, wrong=False")
    ...
    def test_07_statistics(self):
        ...
        print(f"✅ Statistics working: total anchors increased from {total_before} to {total_after}")

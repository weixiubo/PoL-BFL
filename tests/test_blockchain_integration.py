...
class TestBlockchainIntegration(unittest.TestCase):
    ...
    def test_pol_contract_deployment(self):
        ...
        print(f"\n[PASS] PoL contract deployed at: {self.chain_proxy.pol_contract.address}")
        print(f"  Owner: {owner}")
    ...
    def test_client_registration(self):
        ...
        print(f"\n[PASS] Client registration verified")
    ...
    def test_submit_pol_proof(self):
        ...
        print(f"\n[PASS] PoL proof submitted successfully")
    ...
    def test_record_verification(self):
        ...
        print(f"\n[PASS] Verification recorded successfully")
    ...
    def test_batch_record_verification(self):
        ...
        print(f"\n[PASS] Batch verification recorded successfully")
    ...
    def test_get_pol_stats(self):
        ...
        print(f"\n[PASS] PoL stats retrieved successfully")
    ...
    def test_full_workflow(self):
        ...
        self.assertTrue(success)
        print(f"  [PASS] Verification recorded")
        ...
        self.assertTrue(proof['verified'])
        self.assertTrue(proof['is_valid'])
        print(f"  [PASS] Proof verified: {proof['is_valid']}")

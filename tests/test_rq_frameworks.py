...
def test_rq1_framework():
    ...
    try:
        ...
        logger.info("[PASS] RQ1 framework imported successfully")

        # Try to initialize
        exp = SecurityExperiment(RQ1_SIMPLE_CONFIG)
        logger.info("[PASS] RQ1 SecurityExperiment initialized")
        return True
    except Exception as e:
        logger.error(f"[FAIL] RQ1 framework failed: {e}")
        import traceback
        traceback.print_exc()
        return False
...
def test_rq2_framework():
    ...
    try:
        ...
        logger.info("[PASS] RQ2 framework imported successfully")

        # Try to initialize
        exp = AblationStudyExperiment(RQ2_ABLATION_CONFIG)
        logger.info("[PASS] RQ2 AblationStudyExperiment initialized")
        return True
    except Exception as e:
        logger.error(f"[FAIL] RQ2 framework failed: {e}")
        import traceback
        traceback.print_exc()
        return False
...
def test_rq3_framework():
    ...
    try:
        ...
        logger.info("[PASS] RQ3 framework imported successfully")

        # Try to initialize
        exp = OverheadExperiment(RQ3_CONFIG)
        logger.info("[PASS] RQ3 OverheadExperiment initialized")
        return True
    except Exception as e:
        logger.error(f"[FAIL] RQ3 framework failed: {e}")
        import traceback
        traceback.print_exc()
        return False
...
def test_rq4_framework():
    ...
    try:
        ...
        logger.info("[PASS] RQ4 framework imported successfully")

        # Try to initialize
        exp = IncentiveExperiment(RQ4_CONFIG)
        logger.info("[PASS] RQ4 IncentiveExperiment initialized")
        return True
    except Exception as e:
        logger.error(f"[FAIL] RQ4 framework failed: {e}")
        import traceback
        traceback.print_exc()
        return False

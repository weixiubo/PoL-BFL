...
def main():
    ...
    ap.add_argument('--out_json', default='resources/LOG/paper_coverage_report.json')
    ...
    report = {
        ...
        'gates': gates,
        'note': 'Report-only gates; one-round execution does not represent full-scale results.'
    }

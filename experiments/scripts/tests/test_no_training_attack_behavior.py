...
def create_test_dataloader(num_samples=100, input_size=28*28, num_classes=10):
    """Create a deterministic data loader for testing."""
...
def test_no_training_attack():
    ...
    logger.info("SUMMARY")
    logger.info("="*80)
    logger.info(f"1. should_train() returns False: [PASS]")
    logger.info(f"2. Training was skipped: [PASS]")

...
if exp1_ok and exp2_ok:
    print("✅ Both experiments passed quality checks!")
    sys.exit(0)
else:
    print("❌ One or more experiments failed quality checks")
    sys.exit(1)
...
if [ $ANALYSIS_EXIT_CODE -eq 0 ]; then
    echo "✅ Analysis complete - Ready for next batch"
else
    echo "❌ Analysis found issues - Please review"
fi
echo "=========================================="

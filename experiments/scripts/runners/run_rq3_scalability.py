...
RQ3_CONFIG = {
    ...
    'scalability': {
        'num_clients_list': [5, 10, 20],  # Reduced for smoke testing
...
class ScalabilityExperiment:
    ...
    def run_one_configuration(self, num_clients, clients_per_round, checkpoint_interval):
        ...
        for round_num in range(self.config['num_rounds']):
            ...
            # Measure compatibility-path validation overhead.
            verification_start = time.time()

            # This reduced-scale compatibility probe measures parameter distance.
            # Paper-scale verification is implemented by experiments.final.
            for i, client_idx in enumerate(selected_indices):
                client_model_state = client_models[i]
                # Calculate the distance from the global model.
                param_distance = 0.0
                ...
                # A nonzero distance confirms that local training changed the model.
                is_valid = param_distance > 0

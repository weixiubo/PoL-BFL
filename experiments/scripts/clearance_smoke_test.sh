...
# 输出目录
OUTPUT_BASE="experiments/results/clearance"
mkdir -p "$OUTPUT_BASE"
...
# ============================================
# 阶段1: RQ1 MNIST (5轮) - 最快验证
# ============================================
log "=========================================="
log "阶段1: RQ1 MNIST Smoke Test (5轮)"
log "=========================================="
...
log "  - 监控脚本: bash experiments/scripts/monitor_clearance.sh"
log ""
log "预计完成时间: $(date -d '+6 hours' +'%Y-%m-%d %H:%M:%S')"
log ""

# 保存启动信息
cat > "$OUTPUT_BASE/clearance_status.txt" << EOF
PoL-BFL 轻量级清障Smoke Test
...
log_success "清障实验已启动！"
log "状态文件: $OUTPUT_BASE/clearance_status.txt"
log ""
...
log "=========================================="
log "提示: 使用 Ctrl+C 不会终止后台进程"
log "如需终止，请使用: kill $GPU0_PID $GPU1_PID"
log "=========================================="

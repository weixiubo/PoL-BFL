...
# 定义日志文件
LOGS=(
    "experiments/logs/rq1_20251114_212528_quick_clearance_v2.log:vr=0.3(默认)"
...
echo ""
echo "基于当前数据分析："
echo "  ✅ 所有 verification_rate (0.1, 0.2, 0.3) 在无攻击下 FPR 都为 0"
echo "  ✅ verification_rate=0.3 准确率最高 (0.9898)"
echo "  📊 不同 vr 对攻击检测率影响需要进一步分析"
echo ""

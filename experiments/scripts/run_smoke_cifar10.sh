#!/usr/bin/env bash
set -euo pipefail
# Run a smoke CIFAR-10 RQ2 ablation with specific verification settings
# Usage: run_smoke_cifar10.sh <tag> <gpu_id> <verification_rate> <K_last> <Q_random>
# Example: run_smoke_cifar10.sh c10_vr05_k3q4 0 0.5 3 4

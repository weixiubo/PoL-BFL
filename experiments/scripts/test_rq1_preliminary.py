"""
RQ1 Preliminary Test - Quick validation of all attacks and defenses
...
def run_rq1_test(dataset='MNIST', num_rounds=20, attacks=None, baselines=None):
    ...
    logger.info("=" * 80)
    logger.info("RQ1 Preliminary Test")
    logger.info("=" * 80)
    ...
    try:
        ...
        logger.info("=" * 80)
        logger.info("✅ RQ1 preliminary test completed successfully!")
        return True
    except subprocess.CalledProcessError as e:
        logger.error("=" * 80)
        logger.error(f"❌ RQ1 preliminary test failed with exit code {e.returncode}")
        return False
    except Exception as e:
        logger.error("=" * 80)
        logger.error(f"❌ RQ1 preliminary test failed: {e}")
        return False


def main():
    """Main function"""
    logger.info("Starting RQ1 Preliminary Test...")
    ...
    if success:
        logger.info("")
        logger.info("=" * 80)
        logger.info("🎉 RQ1 Preliminary Test Completed!")
        logger.info("=" * 80)
        ...
        logger.error("")
        logger.error("=" * 80)
        logger.error("❌ RQ1 Preliminary Test Failed!")
        logger.error("=" * 80)

...
All these attacks are PoL-detectable because they don't require real training.
"""
...
class ALIEAttack(BladesAttack):
    ...
    PoL detectability: YES (doesn't require training, just computes statistics)
    """
...
class IPMAttack(BladesAttack):
    ...
    PoL detectability: YES (doesn't require training, just computes negative mean)
    """
...
class MinMaxAttack(BladesAttack):
    ...
    PoL detectability: YES (doesn't require training, uses binary search on statistics)
    """
    ...
    def apply(self, model_state: OrderedDict, global_model: OrderedDict = None,
        ...
        # For simplicity, we use a fixed lambda (can be extended to binary search)

...
Detects and prevents Sybil attacks where attackers create multiple fake identities.
"""
...
if __name__ == "__main__":
    ...
    # Register clients
    defense.register_client('client1', '192.168.1.100', 'device_hash_1')
    defense.register_client('client2', '192.168.1.101', 'device_hash_2')
    defense.register_client('client3', '192.168.1.100', 'device_hash_1')  # Suspicious!

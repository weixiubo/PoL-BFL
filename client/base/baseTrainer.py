...
# Attempt to import blockchain chain proxy; fall back explicitly if unavailable
try:
    from chainfl.interact import chain_proxy  # requires Brownie/Ganache environment
...
class BaseTrainer:
    ...
    def construct_optimizer(self):
        ...
        logger.info(
            f"Constructing Optimizer {self.args['optimizer']}: lr {lr_val}, weight_decay: {self.args['weight_decay']}, momentum {momentum_val}"
        )

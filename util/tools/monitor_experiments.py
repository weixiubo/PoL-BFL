...
def format_results_summary(results_data):
    ...
    summary = [f"📁 Latest results: {results_data['dir']}"]
    summary.append(f"🕒 Last modified: {results_data['last_modified']}")
    summary.append("")
    ...
    for variant_data in results_data['results']:
        ...
        if 'final_accuracy_mean' in variant_data:
            ...
            summary.append(f"🔬 {variant} ({len(results)} repetitions):")
...
def main():
    print("🔍 PoL-BFL Experiment Monitor")
    print("=" * 50)
